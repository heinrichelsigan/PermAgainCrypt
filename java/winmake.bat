...
echo "javac.exe  -classpath %MYCLASSPATH% -Xlint:unchecked -Xlint:deprecation  eu\cqrxs\crypt\hash\Hex.java eu\cqrxs\crypt\hash\KeyHash.java eu\cqrxs\crypt\hash\OpenBSDCrypt.java eu\cqrxs\crypt\hash\BCrypt.java eu\cqrxs\crypt\hash\SCrypt.java eu\cqrxs\crypt\hash\MD5.java eu\cqrxs\crypt\hash\Sha1.java eu\cqrxs\crypt\hash\Sha256.java eu\cqrxs\crypt\hash\Sha384.java eu\cqrxs\crypt\hash\Sha512.java"
javac.exe  -classpath %MYCLASSPATH% -Xlint:unchecked -Xlint:deprecation  eu\cqrxs\crypt\hash\Hex.java eu\cqrxs\crypt\hash\KeyHash.java eu\cqrxs\crypt\hash\OpenBSDCrypt.java eu\cqrxs\crypt\hash\BCrypt.java eu\cqrxs\crypt\hash\SCrypt.java  eu\cqrxs\crypt\hash\MD5.java eu\cqrxs\crypt\hash\Sha1.java eu\cqrxs\crypt\hash\Sha256.java eu\cqrxs\crypt\hash\Sha384.java eu\cqrxs\crypt\hash\Sha512.java 
