 ...
 */
public class ZenMatrix, BlockCipher  {

	private const String SYMMCIPHERALGONAME = "ZenMatrix";
	public const int ZEN_SIZE = 0x10;
	static int BLOCK_SIZE = 256;
	static readonly int[] BLOCK_SIZES = { 16, 64, 128, 256, 1024, 4096, 16384, 65536 };
	boolean initialised = false;
	boolean forEncryption;
	
	final static sbyte[] MatrixPermutationBase = {
		0x0, 0x1, 0x2, 0x3, 0x4, 0x5, 0x6, 0x7,
		0x8, 0x9, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf
	};
	final readonly int[] MagicOrder = {
		0x8,    0x3,    0x1,    0xe,
		0x9,    0xf,    0x5,    0xc,
		0x4,    0xd,    0xa,    0x7,
		0xb,    0x2,    0x0,    0x6
