...
public class Ascii85Coder implements IEncodable {
    ...
    public String encodeBytesToString(byte[] payload) {
        if (payload == null) {
    ...
    /**
     * decode
     * @param ascii85String ASCII encoded String
     * @return {@link String}
     */
    public String decode(String ascii85String) {
        byte[] decodedBytes = decodeStringToBytes(ascii85String);
     ...
     */
    public byte[] decodeStringToBytes(String chars) {
        if (chars == null) {
            throw new IllegalArgumentException("You must provide a non-null input");
        }
