...
namespace EU.CqrXs.Crypt.Cipher
{
    ...
    public class MatrixPipe : CipherPipe
    {
            ...
            CipherMode2 cmode2 = CipherMode2.CFB)
        {
            ...
            CipherEnum[] inPipe = new CipherEnum[8];
            Array.Copy(cipherEnums, inPipe, isize);

            CipherEnum[] inPipe0 = new CipherEnum[] { inPipe[0], inPipe[1], inPipe[2], inPipe[3], inPipe[4], inPipe[5], inPipe[6], inPipe[7] };
            CipherEnum[] inPipe1 = new CipherEnum[] { inPipe[1], inPipe[2], inPipe[3], inPipe[4], inPipe[5], inPipe[6], inPipe[7], inPipe[0] };
            CipherEnum[] inPipe2 = new CipherEnum[] { inPipe[2], inPipe[3], inPipe[4], inPipe[5], inPipe[6], inPipe[7], inPipe[0], inPipe[1] };
            CipherEnum[] inPipe3 = new CipherEnum[] { inPipe[3], inPipe[4], inPipe[5], inPipe[6], inPipe[7], inPipe[0], inPipe[1], inPipe[2] };
            CipherEnum[] inPipe4 = new CipherEnum[] { inPipe[4], inPipe[5], inPipe[6], inPipe[7], inPipe[0], inPipe[1], inPipe[2], inPipe[3] };
            CipherEnum[] inPipe5 = new CipherEnum[] { inPipe[5], inPipe[6], inPipe[7], inPipe[0], inPipe[1], inPipe[2], inPipe[3], inPipe[4] };
            CipherEnum[] inPipe6 = new CipherEnum[] { inPipe[6], inPipe[7], inPipe[0], inPipe[1], inPipe[2], inPipe[3], inPipe[4], inPipe[5] };
            CipherEnum[] inPipe7 = new CipherEnum[] { inPipe[7], inPipe[0], inPipe[1], inPipe[2], inPipe[3], inPipe[4], inPipe[5], inPipe[6] };
            inPipes.Add(inPipe0);
            inPipes.Add(inPipe1);
            inPipes.Add(inPipe2);
            inPipes.Add(inPipe3);
            ...
            CipherMode2 cmode2 = CipherMode2.CFB)
        {
            ...
            CipherEnum[] inPipe = cipherEnums.ToArray();
            CipherEnum[] inPipe0 = new CipherEnum[] { inPipe[0], inPipe[1], inPipe[2], inPipe[3], inPipe[4], inPipe[5], inPipe[6], inPipe[7] };
            CipherEnum[] inPipe1 = new CipherEnum[] { inPipe[1], inPipe[2], inPipe[3], inPipe[4], inPipe[5], inPipe[6], inPipe[7], inPipe[0] };
            CipherEnum[] inPipe2 = new CipherEnum[] { inPipe[2], inPipe[3], inPipe[4], inPipe[5], inPipe[6], inPipe[7], inPipe[0], inPipe[1] };
            CipherEnum[] inPipe3 = new CipherEnum[] { inPipe[3], inPipe[4], inPipe[5], inPipe[6], inPipe[7], inPipe[0], inPipe[1], inPipe[2] };
            ...
            CipherMode2 cmode2 = CipherMode2.CFB, bool verbose = false)
        {
            ...
            CipherEnum[] inPipe = pipeList.ToArray();
            CipherEnum[] inPipe0 = new CipherEnum[] { inPipe[0], inPipe[1], inPipe[2], inPipe[3], inPipe[4], inPipe[5], inPipe[6], inPipe[7] };
            CipherEnum[] inPipe1 = new CipherEnum[] { inPipe[1], inPipe[2], inPipe[3], inPipe[4], inPipe[5], inPipe[6], inPipe[7], inPipe[0] };
            CipherEnum[] inPipe2 = new CipherEnum[] { inPipe[2], inPipe[3], inPipe[4], inPipe[5], inPipe[6], inPipe[7], inPipe[0], inPipe[1] };
            CipherEnum[] inPipe3 = new CipherEnum[] { inPipe[3], inPipe[4], inPipe[5], inPipe[6], inPipe[7], inPipe[0], inPipe[1], inPipe[2] };
        ...
        #region static members EncryptBytesFast DecryptBytesFast multiple rounds en-de-cryption
        /******************************************************************************
                    /// <summary>
                    ...
                    public static new byte[] EncryptBytesFast(byte[] inBytes, CipherEnum cipherAlgo, 
            ...
            */
        #endregion static members EncryptBytesFast DecryptBytesFast multiple rounds en-de-cryption
