...
namespace EU.CqrXs.Crypt.Cipher.Symmetric
{
    ...
    // IBinaryInteger<byte>
    {
        ...
        public const byte MaxValue = (byte)0xF;
        ...
        private static readonly byte One = (byte)1;

        /// <summary>Represents the number zero (0).</summary>
        private static readonly byte Zero = (byte)0;
        ...
        public int CompareTo(object? value)
        {
            ...
            if (!(value is byte))
            {
                throw new ArgumentException("Argument must be convertible to byte");
            }
 
            return m_value - (((Hex)value).m_value);
        }
        ...
        public override bool Equals([NotNullWhen(true)] object? obj)
        {
            ...
            return m_value == ((Hex)obj).m_value;
        }
        ...
        {
            if (s is null) { ThrowHelper.ThrowArgumentNullException(s); }
        ...
        public static bool TryParse([NotNullWhen(true)] string? s, out byte result) => Byte.TryParse(s, NumberStyles.Integer, provider: null, out result);

        public static bool TryParse(ReadOnlySpan<char> s, out byte result) => Byte.TryParse(s, NumberStyles.Integer, provider: null, out result);
        ...
        //{
        //    NumberFormatInfo.ValidateParseStyleInteger(style);
        //    return Byte.TryParseBinaryInteger(s, style, NumberFormatInfo.GetInstance(provider), out result) == ParsingStatus.OK;
        //}
        ...
        {
            return m_value.ToString(format, null);
        }
        ...
        {
            return Convert.ToBoolean((m_value & 0x0f));
        }

        char IConvertible.ToChar(IFormatProvider? provider)
        {
            return Convert.ToChar(m_value & 0x0f);
        }

        sbyte IConvertible.ToSByte(IFormatProvider? provider)
        {
            return Convert.ToSByte(m_value & 0x0f);
        }
        ...
        {
            return Convert.ToInt16(m_value & 0x0f);
        }

        ushort IConvertible.ToUInt16(IFormatProvider? provider)
        {
            return Convert.ToUInt16(m_value & 0x0f);
        }

        int IConvertible.ToInt32(IFormatProvider? provider)
        {
            return Convert.ToInt32(m_value & 0x0f);
        }

        uint IConvertible.ToUInt32(IFormatProvider? provider)
        {
            return Convert.ToUInt32(m_value & 0x0f);
        }

        long IConvertible.ToInt64(IFormatProvider? provider)
        {
            return Convert.ToInt64(m_value & 0x0f);
        }

        ulong IConvertible.ToUInt64(IFormatProvider? provider)
        {
            return Convert.ToUInt64(m_value & 0x0f);
        }

        float IConvertible.ToSingle(IFormatProvider? provider)
        {
            return Convert.ToSingle(m_value & 0x0f);
        }

        double IConvertible.ToDouble(IFormatProvider? provider)
        {
            return Convert.ToDouble(m_value & 0x0f);
        }

        decimal IConvertible.ToDecimal(IFormatProvider? provider)
        {
            return Convert.ToDecimal(m_value & 0x0f);
        }
        ...
        Hex ToHex(IFormatProvider ? provider)
        {
            return (Hex)(m_value);
        }
        ...
        {
            return (IConvertible)((byte)Convert.ToByte(this.ToString(), type, provider) & 0x0f);
        }
        ...
        static byte IAdditionOperators<byte, byte, byte>.operator +(byte left, byte right) => (byte)((left & 0x0f) + (right & 0x0f));

        /// <inheritdoc cref="IAdditionOperators{TSelf, TOther, TResult}.op_CheckedAddition(TSelf, TOther)" />
        static byte IAdditionOperators<byte, byte, byte>.operator checked +(byte left, byte right) => checked(((byte)((left & 0x0f) + (right & 0x0f))));
        ...
        public static byte PopCount(byte value) => (byte)BitOperations.PopCount((byte)(value & 0x0f));
        ...
        */ 
        ...
        static byte IBitwiseOperators<byte, byte, byte>.operator &(byte left, byte right) => (byte)((left & 0x0f) & (right & 0x0f));
        ...
        static byte IBitwiseOperators<byte, byte, byte>.operator ~(byte value) => (byte)((~value) & 0xf);
        */
        //
        ...
        static bool IComparisonOperators<byte, byte, bool>.operator <(byte left, byte right) => (left & 0x0f) < (right & 0x0f);
        ...
        static byte IDivisionOperators<byte, byte, byte>.operator /(byte left, byte right) => (byte)((left & 0x0f) / (right & 0x0f));
        ...
        static bool IEqualityOperators<byte, byte, bool>.operator ==(byte left, byte right) => (left & 0x0f) == (right & 0x0f);
        ...
        static byte IModulusOperators<byte, byte, byte>.operator %(byte left, byte right) => (byte)((left & 0x0f) % (right & 0x0f));
        ...
        static byte IMultiplyOperators<byte, byte, byte>.operator *(byte left, byte right) => (byte)(((left & 0x0f) * (right & 0x0f)) & 0x0f);

        /// <inheritdoc cref="IMultiplyOperators{TSelf, TOther, TResult}.op_CheckedMultiply(TSelf, TOther)" />
        static byte IMultiplyOperators<byte, byte, byte>.operator checked *(byte left, byte right) => checked((byte)(((left & 0x0f) * (right & 0x0f)) & 0x0f));
        ...
        public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, out byte result) => Byte.TryParse(s, NumberStyles.Integer, provider, out result);
        ...
        public static byte Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => Byte.Parse(s, NumberStyles.Integer, provider);

        /// <inheritdoc cref="ISpanParsable{TSelf}.TryParse(ReadOnlySpan{char}, IFormatProvider?, out TSelf)" />
        public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out byte result) => Byte.TryParse(s, NumberStyles.Integer, provider, out result);
        ...
        public static Hex operator --(Hex value)
        {
            throw new NotImplementedException();
        }
        ...
        public static bool operator <(Hex left, byte right)
        {
        ...
        //{
        //    // NumberFormatInfo.ValidateParseStyleInteger(style);
        //    return Byte.Parse<byte>(utf8Text, style, NumberFormatInfo.GetInstance(provider));
        //}
        ...
        {
            // NumberFormatInfo.ValidateParseStyleInteger(style);
            return Byte.TryParse(utf8Text, style, NumberFormatInfo.GetInstance(provider), out result);
        }

        /// <inheritdoc cref="IUtf8SpanParsable{TSelf}.Parse(ReadOnlySpan{byte}, IFormatProvider?)" />
        public static byte Parse(ReadOnlySpan<byte> utf8Text, IFormatProvider? provider) => Byte.Parse(utf8Text, NumberStyles.Integer, provider);

        /// <inheritdoc cref="IUtf8SpanParsable{TSelf}.TryParse(ReadOnlySpan{byte}, IFormatProvider?, out TSelf)" />
        public static bool TryParse(ReadOnlySpan<byte> utf8Text, IFormatProvider? provider, out byte result) => Byte.TryParse(utf8Text, NumberStyles.Integer, provider, out result);

        public static Hex Abs(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsCanonical(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsComplexNumber(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsEvenInteger(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsFinite(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsImaginaryNumber(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsInfinity(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsInteger(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsNaN(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsNegative(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsNegativeInfinity(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsNormal(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsOddInteger(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsPositive(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsPositiveInfinity(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsRealNumber(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsSubnormal(Hex value)
        {
            throw new NotImplementedException();
        }

        public static bool IsZero(Hex value)
        {
            throw new NotImplementedException();
        }

        public static Hex MaxMagnitude(Hex x, Hex y)
        {
            throw new NotImplementedException();
        }

        public static Hex MaxMagnitudeNumber(Hex x, Hex y)
        {
            throw new NotImplementedException();
        }

        public static Hex MinMagnitude(Hex x, Hex y)
        {
            throw new NotImplementedException();
        }

        public static Hex MinMagnitudeNumber(Hex x, Hex y)
        {
            throw new NotImplementedException();
        }

        public static Hex Parse(ReadOnlySpan<char> s, NumberStyles style, IFormatProvider? provider)
        {
            throw new NotImplementedException();
        }

        static Hex INumberBase<Hex>.Parse(string s, NumberStyles style, IFormatProvider? provider)
        {
            throw new NotImplementedException();
        }

        public static bool TryConvertFromChecked<TOther>(TOther value, [MaybeNullWhen(false)] out Hex result) where TOther : INumberBase<TOther>
        {
            throw new NotImplementedException();
        }

        public static bool TryConvertFromSaturating<TOther>(TOther value, [MaybeNullWhen(false)] out Hex result) where TOther : INumberBase<TOther>
        {
            throw new NotImplementedException();
        }

        public static bool TryConvertFromTruncating<TOther>(TOther value, [MaybeNullWhen(false)] out Hex result) where TOther : INumberBase<TOther>
        {
            throw new NotImplementedException();
        }

        public static bool TryConvertToChecked<TOther>(Hex value, [MaybeNullWhen(false)] out TOther result) where TOther : INumberBase<TOther>
        {
            throw new NotImplementedException();
        }

        public static bool TryConvertToSaturating<TOther>(Hex value, [MaybeNullWhen(false)] out TOther result) where TOther : INumberBase<TOther>
        {
            throw new NotImplementedException();
        }

        public static bool TryConvertToTruncating<TOther>(Hex value, [MaybeNullWhen(false)] out TOther result) where TOther : INumberBase<TOther>
        {
            throw new NotImplementedException();
        }

        public static bool TryParse(ReadOnlySpan<char> s, NumberStyles style, IFormatProvider? provider, [MaybeNullWhen(false)] out Hex result)
        {
            throw new NotImplementedException();
        }

        public static bool TryParse([NotNullWhen(true)] string? s, NumberStyles style, IFormatProvider? provider, [MaybeNullWhen(false)] out Hex result)
        {
            throw new NotImplementedException();
        }
        ...
        static Hex ISpanParsable<Hex>.Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
        {
            throw new NotImplementedException();
        }

        public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, [MaybeNullWhen(false)] out Hex result)
        {
            throw new NotImplementedException();
        }

        static Hex IParsable<Hex>.Parse(string s, IFormatProvider? provider)
        {
            throw new NotImplementedException();
        }

        public static bool TryParse([NotNullWhen(true)] string? s, IFormatProvider? provider, [MaybeNullWhen(false)] out Hex result)
        {
            throw new NotImplementedException();
        }
