...
namespace Area23.At.Framework.Core.Crypt.Cipher.Symmetric
{
    ...
    public class ZenMatrix2 : ZenMatrix
    {
        ...
        /// public constructor
        /// </summary>
        public ZenMatrix2(int bs = 32) : base(bs)
        {
            sbyte sbcnt2 = 0x0;
        ...
        public ZenMatrix2(string secretKey = "", string hashIV = "", bool fullSymmetric = false) : this(32)
        {
        ...
        /// fullSymmetric means that zen matrix is it's inverse element 
        /// and decrypts back to plain text, when encrypting twice or ²</param> 
        public ZenMatrix2(byte[] keyBytes, bool fullSymmetric = false) : this(32)
        {
