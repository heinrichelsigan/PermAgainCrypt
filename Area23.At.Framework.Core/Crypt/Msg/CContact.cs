...
namespace Area23.At.Framework.Core.Crypt.Msg
{
    ...
    public class CContact : CMsg, IMsgAble
    {
        ...
        public override string EncryptToJson(string serverKey, EncodingType encoder = EncodingType.Base64, ZipType zipType = ZipType.None)
        {
            ...
            throw new CException($"EncryptToJson(string severKey) failed for CContact.");
        }
        ...
        )
        {
            ...
            throw new CException($"DecryptFromJson<T>(string severKey, string serialized) failed for CContact");
        }
        ...
        )
        {
            ...
            try
            {
                ...
                encrypted = SymmCipherPipe.EncrpytToString(ccntct.Message, serverKey, out pipeString, encoder, zipType, KeyHash.SCrypt);
        ...
        {
            if (string.IsNullOrEmpty(serialized))
                throw new CException("static CContact FromJsonDecrypt(string serverKey, string serialized): serialized is null or empty.");
            ...
            if (decrContact == null)
                throw new CException($"static CContact FromJsonDecrypt(string serverKey, string serialized) failed.");
        ...
        public static CContact DecryptSrvMsg(
            ...
            ref CContact ccntct,
            EncodingType decoder = EncodingType.Base64, 
            Zip.ZipType zipType = Zip.ZipType.None
        )
        {
